...
function crearServidorMcp() {
  ...
  server.tool(
    ...
    'Corre matchmaking para TODOS los sponsors activos de Fashion Digital Talks 2026 a la vez y detecta cuándo el mismo asistente sale como candidato fuerte para más de un sponsor (solapamiento). Aplica las mismas reglas del cálculo individual: Área conocida no solicitada queda fuera incluso para VIP/Speaker; Área vacía/Otro entra sin puntos; el ranking premia Grande sobre Mediana (Pequeña +50 / Micro +30); hace falta ≥1 solución coincidente salvo oro molido; soluciones 20/40/60/80. Las explicaciones describen la vía de entrada por tamaño y no incluyen cuota pendiente cambiante. Presenta los matches por empresa; los nombres de persona son solo fallback. Operación pesada. Por default NO escribe en Notion (dry-run) — solo cuando escribirEnNotion=true crea filas en Citas con Estatus "Sugerido" para los candidatos de cada sponsor. NO crea citas reales ni aprueba nada. Un sponsor con error individual (ej. nivel Bronce) no detiene la corrida completa, se reporta en "omitidos".',
    {
