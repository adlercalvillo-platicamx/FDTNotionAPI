...
Fecha del trabajo: 24 sep 2026. Continúa [bitacora-18sep-sponsors-nuevos-laura.md](bitacora-18sep-sponsors-nuevos-laura.md).
...
1. Deploy backend **sin** la env → el resto de sponsors igual que hoy.
