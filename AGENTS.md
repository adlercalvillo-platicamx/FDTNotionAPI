...
| Sugeridas del asistente | GET `/citas/sugeridas?whatsapp=` (mismo payload que el MCP: `sugeridas` = Aprobado; `opciones_adicionales` = Sugerido + giro/tamaño). | `consultar_sugeridas_para_asistente` (`whatsapp`; capa 1 = cancelada reagendable + Aprobado, tope 4; capa 2 = `opciones_adicionales`; + confirmadas/canceladas) |
