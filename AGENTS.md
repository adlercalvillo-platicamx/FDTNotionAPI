...
- Capa 1: filtros duros (boleto, giro, etapa, no “Dado de Baja”, no Expo). Capa 2: ranking en [`matchmaking.service.js`](src/services/matchmaking.service.js) (pesos `PESOS`).
