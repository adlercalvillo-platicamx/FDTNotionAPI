...
| Respaldo Notion → R2 | **POST `/notion/respaldar`** (`X-API-Key`; cron diario ~03:00 CDMX). Solo lectura de Contactos/Citas; gzip a Cloudflare R2. Sin credenciales R2 → **503**. No MCP. | — |
