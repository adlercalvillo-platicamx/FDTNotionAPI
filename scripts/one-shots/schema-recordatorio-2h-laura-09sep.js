#!/usr/bin/env node
/**
 * Agrega a Citas de Laura los campos del recordatorio 2 horas (cron).
 *
 * Dry-run:  node scripts/one-shots/schema-recordatorio-2h-laura-09sep.js
 * Escribe:  node scripts/one-shots/schema-recordatorio-2h-laura-09sep.js --confirmar
 */
...
async function main() {
  ...
  console.log('PATCH ok. Campos de recordatorio 2h presentes.');
}
